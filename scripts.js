...
const urlStatic = "https://maps.googleapis.com/maps/api/staticmap?"
...
mymap.addEventListener("click", (e) => {
  ...
  getElevation(
    "https://maps.googleapis.com/maps/api/elevation/json?locations=" + mlat +"," + mlng + "&key=AIzaSyA8c4QHC43f_e06VHKWB5lNHd3dYxmJjjY"
  );
});
